...
// VidmCreateLocalUserRequestDTO VidmCreateLocalUserRequestDTO
//
// swagger:model VidmCreateLocalUserRequestDTO
type VidmCreateLocalUserRequestDTO struct {

	// assign tenant admin role
	AssignTenantAdminRole bool `json:"assignTenantAdminRole,omitempty"`
...
// Validate validates this vidm create local user request d t o
func (m *VidmCreateLocalUserRequestDTO) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *VidmCreateLocalUserRequestDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *VidmCreateLocalUserRequestDTO) UnmarshalBinary(b []byte) error {
	var res VidmCreateLocalUserRequestDTO
