...
//
// swagger:model LicenseRequestDTO
...
// Validate validates this license request d t o
func (m *LicenseRequestDTO) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *LicenseRequestDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LicenseRequestDTO) UnmarshalBinary(b []byte) error {
	var res LicenseRequestDTO
