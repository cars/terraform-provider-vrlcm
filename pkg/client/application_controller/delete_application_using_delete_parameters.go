...
// WithVmid adds the vmid to the delete application using d e l e t e params
func (o *DeleteApplicationUsingDELETEParams) WithVmid(vmid string) *DeleteApplicationUsingDELETEParams {
	o.SetVmid(vmid)
	return o
}

// SetVmid adds the vmid to the delete application using d e l e t e params
func (o *DeleteApplicationUsingDELETEParams) SetVmid(vmid string) {
	o.Vmid = vmid
}
