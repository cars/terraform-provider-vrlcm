...
func (o *CreateApplicationUsingPOSTOK) Error() string {
	return fmt.Sprintf("[POST /lcm/shell/api/apps][%d] createApplicationUsingPOSTOK  %+v", 200, o.Payload)
}
...
func (o *CreateApplicationUsingPOSTCreated) Error() string {
	return fmt.Sprintf("[POST /lcm/shell/api/apps][%d] createApplicationUsingPOSTCreated ", 201)
}
...
func (o *CreateApplicationUsingPOSTUnauthorized) Error() string {
	return fmt.Sprintf("[POST /lcm/shell/api/apps][%d] createApplicationUsingPOSTUnauthorized ", 401)
}
...
func (o *CreateApplicationUsingPOSTForbidden) Error() string {
	return fmt.Sprintf("[POST /lcm/shell/api/apps][%d] createApplicationUsingPOSTForbidden ", 403)
}
...
func (o *CreateApplicationUsingPOSTNotFound) Error() string {
	return fmt.Sprintf("[POST /lcm/shell/api/apps][%d] createApplicationUsingPOSTNotFound ", 404)
}
