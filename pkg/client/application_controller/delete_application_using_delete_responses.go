...
func (o *DeleteApplicationUsingDELETEOK) Error() string {
	return fmt.Sprintf("[DELETE /lcm/shell/api/apps/{vmid}][%d] deleteApplicationUsingDELETEOK ", 200)
}
...
func (o *DeleteApplicationUsingDELETENoContent) Error() string {
	return fmt.Sprintf("[DELETE /lcm/shell/api/apps/{vmid}][%d] deleteApplicationUsingDELETENoContent ", 204)
}
...
func (o *DeleteApplicationUsingDELETEUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /lcm/shell/api/apps/{vmid}][%d] deleteApplicationUsingDELETEUnauthorized ", 401)
}
...
func (o *DeleteApplicationUsingDELETEForbidden) Error() string {
	return fmt.Sprintf("[DELETE /lcm/shell/api/apps/{vmid}][%d] deleteApplicationUsingDELETEForbidden ", 403)
}
