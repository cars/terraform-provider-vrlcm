...
func (o *CreateRoleUsingPOSTOK) Error() string {
	return fmt.Sprintf("[POST /lcm/authzn/api/roles][%d] createRoleUsingPOSTOK  %+v", 200, o.Payload)
}

func (o *CreateRoleUsingPOSTOK) GetPayload() interface{} {
	return o.Payload
}
...
func (o *CreateRoleUsingPOSTCreated) Error() string {
	return fmt.Sprintf("[POST /lcm/authzn/api/roles][%d] createRoleUsingPOSTCreated ", 201)
}
...
func (o *CreateRoleUsingPOSTUnauthorized) Error() string {
	return fmt.Sprintf("[POST /lcm/authzn/api/roles][%d] createRoleUsingPOSTUnauthorized ", 401)
}
...
func (o *CreateRoleUsingPOSTForbidden) Error() string {
	return fmt.Sprintf("[POST /lcm/authzn/api/roles][%d] createRoleUsingPOSTForbidden ", 403)
}
...
func (o *CreateRoleUsingPOSTNotFound) Error() string {
	return fmt.Sprintf("[POST /lcm/authzn/api/roles][%d] createRoleUsingPOSTNotFound ", 404)
}
